...
![service-topology](/img/docs/user-manuals/network/service-topology-example.png)
...
开启 `kube-proxy` 的 `EndpointSliceProxying` [特性门控]([特性门控 | Kubernetes](https://kubernetes.io/zh/docs/reference/command-line-tools-reference/feature-gates/))，并配置其连接 `Yurthub`。
