...
![img](../../../../static/img/prometheus-endpoint-shooting.png)
...
![img](../../../../static/img/crictl-ps-shooting.png)
...
```shell
$ dig @10.96.0.10 $无法访问的pod所在节点名称<edge-pi-node-02>
```

![img](../../../../static/img/crictl-dig-shooting.png)
...
![img](../../../../static/img/crictl-curl-ipvs-shooting.png)
